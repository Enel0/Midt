...
export function regiones() { return REGIONES_COMUNAS.map(r => r.region); }
export function comunasByRegion(region) { return REGIONES_COMUNAS.find(r => r.region === region)?.comunas || []; }
